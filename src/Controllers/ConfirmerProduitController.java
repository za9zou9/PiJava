 ...
 * @author Imene
 */
public class ConfirmerProduitController implements Initializable {
  ...
  public ObservableList<Commande> data2=FXCollections.observableArrayList();
    ...
    @FXML
    private void confirmer(MouseEvent event) throws IOException {
         ProduitServices ps = new ProduitServices();
       
        ps.UpdateProduit(p,p.getIdProduit());
...
public Produit p;
    ...
    private void onselectLigne(MouseEvent event) {
       ...
       if (p != null){
          ...
          prix1.setText(Integer.toString(p.getPrix()));
          description1.setText(p.getDescription());
          quantite1.setText(Integer.toString(p.getQuantite()));
          image1.setText(p.getImage());
