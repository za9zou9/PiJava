 ...
 * @author skan
 */
public class FXMListeEventsPastController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
      EvenementServices es=new EvenementServices();
        List<Evenement> listeE = es.selectEvenemntPasses();
        ...
        for(int i=0;i<listeE.size();i++){
           ...
           titre.setOnAction(new EventHandler<ActionEvent>() {
               ...
               public void handle(ActionEvent event) {
                FXMLLoader loader= new FXMLLoader(getClass().getResource("FXMLDetailsEventPast.fxml"));
                Parent root;
                   try {
                       root=loader.load();
                       FXMLDetailsEventPastController dc=loader.getController();
